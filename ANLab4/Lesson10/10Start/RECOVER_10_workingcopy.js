...
lib.ssMetadata = [
		{name:"RECOVER_10_workingcopy_atlas_1", frames: [[357,0,520,132],[688,134,220,150],[0,397,212,52],[716,286,214,101],[0,451,178,59],[716,389,216,66],[357,328,357,160],[879,50,80,36],[0,0,355,395],[357,134,329,192],[879,0,80,48]]}
];
...
(lib.CachedBmp_2 = function() {
	this.initialize(ss["RECOVER_10_workingcopy_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.Symbol4, new cjs.Rectangle(0,0,80,36), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(0,0,80,48), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(22.1,119.6,0.5,0.5);

	this.instance_1 = new lib._2022racer();
...
}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(0,0,391.3,291.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(27.85,129.6,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(0,0,378.7,309.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:1.0228,scaleY:1.0282,y:24.05},0).wait(1).to({scaleX:1.0456,scaleY:1.0565,y:24},0).wait(1).to({scaleX:1.0683,scaleY:1.0847,x:40.05,y:24.05},0).wait(1).to({scaleX:1.0911,scaleY:1.113,y:24},0).wait(1).to({scaleX:1.1139,scaleY:1.1412,x:40,y:24.05},0).wait(1).to({scaleX:1.1367,scaleY:1.1694,y:24},0).wait(1).to({scaleX:1.1594,scaleY:1.1977,x:40.05,y:24.05},0).wait(1).to({scaleX:1.1822,scaleY:1.2259,y:24},0).wait(1).to({scaleX:1.205,scaleY:1.2542,x:40},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-8.1,-6,96.39999999999999,60.2);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:1.02,scaleY:1.0404,x:40.05,y:18.05},0).wait(1).to({scaleX:1.04,scaleY:1.0809,y:18},0).wait(1).to({scaleX:1.06,scaleY:1.1213,y:18.05},0).wait(1).to({scaleX:1.08,scaleY:1.1617,y:18},0).wait(1).to({scaleX:1.1,scaleY:1.2022,y:18.05},0).wait(1).to({scaleX:1.12,scaleY:1.2426,y:18},0).wait(1).to({scaleX:1.14,scaleY:1.283,y:18.05},0).wait(1).to({scaleX:1.16,scaleY:1.3235,y:18},0).wait(1).to({scaleX:1.18,scaleY:1.3639},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-7.1,-6.5,94.39999999999999,49.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(45.25,30,1,1,0,0,0,40,24);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance}]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.instance_1}]},1).wait(3));
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(45,32,1,1,0,0,0,40,18);
...
// stage content:
(lib.RECOVER_10_workingcopy = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(514.45,97.3,1,1,0,0,0,189.3,154.6);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).wait(1).to({x:451.7},0).wait(1).to({x:388.95},0).wait(1).to({x:326.2},0).wait(1).to({x:263.45},0).to({_off:true},1).wait(6));

	// Layer_4
	this.instance_1 = new lib.Symbol2();
	this.instance_1.setTransform(557.5,92.35,1,1,0,0,0,195.6,145.7);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(24).to({_off:false},0).wait(1).to({x:499.7},0).wait(1).to({x:441.9},0).wait(1).to({x:384.1},0).wait(1).to({x:326.3},0).wait(1).to({x:268.5},0).wait(1));
	...
	this.racer_btn = new lib.racer();
	this.racer_btn.name = "racer_btn";
	this.racer_btn.setTransform(7,205);
	new cjs.ButtonHelper(this.racer_btn, 0, 1, 2, false, new lib.racer(), 3);

	this.ultra_btn = new lib.ultra();
	this.ultra_btn.name = "ultra_btn";
	this.ultra_btn.setTransform(52,172.5,1,1,0,0,0,45,32.5);
	new cjs.ButtonHelper(this.ultra_btn, 0, 1, 2, false, new lib.ultra(), 3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:305.35,y:190.35},14,cjs.Ease.get(1)).to({_off:true},5).wait(11));
...
p.nominalBounds = new cjs.Rectangle(22,82.7,731.2,272.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/RECOVER_10_workingcopy_atlas_1.png?1681778121437", id:"RECOVER_10_workingcopy_atlas_1"}
	],
	preloads: []
};
